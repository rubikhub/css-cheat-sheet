...
**[View Example](../examples/intermediate/22-filter-and-clip-path/index.html)**

← **Previous Topic:** [Transform Functions](../intermediate/21-transform-functions.md) &nbsp;&nbsp;|&nbsp;&nbsp; **Next Topic:** [UI & Scroll](../intermediate/23-ui-and-scroll.md) →
