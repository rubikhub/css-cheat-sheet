...
**[View Example](../examples/intermediate/12-counters-and-markers/index.html)**

← **Previous Topic:** [Box Shadows](../intermediate/11-box-shadow.md) &nbsp;&nbsp;|&nbsp;&nbsp; **Next Topic:** [Flexbox Advanced](../intermediate/13-flexbox-advanced.md) →
