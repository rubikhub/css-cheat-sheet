...
**[View Example](../examples/intermediate/19-transition-advanced/index.html)**

← **Previous Topic:** [Pseudo Elements Advanced](../intermediate/18-pseudo-elements-advanced.md) &nbsp;&nbsp;|&nbsp;&nbsp; **Next Topic:** [Transform](../intermediate/20-transform.md) →
