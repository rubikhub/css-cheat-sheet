...
**[View Example](../examples/intermediate/12-pseudo-elements-advanced/index.html)**

← **Previous Topic:** [State Pseudo Classes](../intermediate/11-state-pseudo-classes.md) &nbsp;&nbsp;|&nbsp;&nbsp; **Next Topic:** [Transition Advanced](../intermediate/13-transition-advanced.md) →
