...
**[View Example](../examples/intermediate/15-transform-functions/index.html)**

← **Previous Topic:** [Transform](../intermediate/14-transform.md) &nbsp;&nbsp;|&nbsp;&nbsp; **Next Topic:** [Filter & Clip Path](../intermediate/16-filter-and-clip-path.md) →
