...
**[View Example](../examples/intermediate/21-media-queries/index.html)**

← **Previous Topic:** [Nesting](../intermediate/20-nesting.md) &nbsp;&nbsp;|&nbsp;&nbsp; **Next Topic:** [:has() — The Parent Selector](../advanced/01-has-selector.md) →
