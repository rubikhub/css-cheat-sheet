...
**[View Example](../examples/advanced/12-subgrid/index.html)**

← **Previous Topic:** [CSS Counters — Complex Patterns](../advanced/11-css-counters-complex.md) &nbsp;&nbsp;|&nbsp;&nbsp; **Next Topic:** [Advanced State Pseudo-classes](../advanced/13-state-pseudo-classes-advanced.md) →
