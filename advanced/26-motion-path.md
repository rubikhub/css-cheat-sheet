...
**[View Example](../examples/advanced/26-motion-path/index.html)**

← **Previous Topic:** [Multi-column Layout](../advanced/25-multi-column-layout.md) &nbsp;&nbsp;|&nbsp;&nbsp; **Next Topic:** [Paged Media & Print](../advanced/27-paged-media.md) →
