...
**[View Example](../examples/advanced/07-typography-2024/index.html)**

← **Previous Topic:** [Typography — OpenType & Variable Font Features](../advanced/06-typography-ot-features.md) &nbsp;&nbsp;|&nbsp;&nbsp; **Next Topic:** [Border Image & Caret Color](../advanced/08-border-image-and-caret.md) →
