...
**[View Example](../examples/advanced/11-css-counters-complex/index.html)**

← **Previous Topic:** [Border Image & Caret Color](../advanced/10-border-image-and-caret.md) &nbsp;&nbsp;|&nbsp;&nbsp; **Next Topic:** [Subgrid & Named Grid Lines](../advanced/12-subgrid.md) →
