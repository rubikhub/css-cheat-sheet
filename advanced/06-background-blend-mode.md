...
**[View Example](../examples/advanced/06-background-blend-mode/index.html)**

← **Previous Topic:** [Color Manipulation](../advanced/05-color-manipulation.md) &nbsp;&nbsp;|&nbsp;&nbsp; **Next Topic:** [Typography — OpenType Features](../advanced/07-typography-ot-features.md) →
