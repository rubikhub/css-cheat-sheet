...
Hide or reveal parts of an element with CSS mask images.
...
**[View Example](../examples/advanced/21-css-masks/index.html)**

← **Previous Topic:** [Advanced Visual Effects](../advanced/20-advanced-effects.md) &nbsp;&nbsp;|&nbsp;&nbsp; **Next Topic:** [Scroll Snap & Touch Interaction](../advanced/22-scroll-snap.md) →
