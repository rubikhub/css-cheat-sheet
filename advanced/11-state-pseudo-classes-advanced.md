...
**[View Example](../examples/advanced/11-state-pseudo-classes-advanced/index.html)**

← **Previous Topic:** [Subgrid & Named Grid Lines](../advanced/10-subgrid.md) &nbsp;&nbsp;|&nbsp;&nbsp; **Next Topic:** [Form Pseudo-classes — Advanced](../advanced/12-form-pseudo-classes-advanced.md) →
