...
**[View Example](../examples/beginner/23-gradients-basics/index.html)**

← **Previous Topic:** [Transition Basics](../beginner/22-transition-basics.md) &nbsp;&nbsp;|&nbsp;&nbsp; **Next Topic:** [Logical Properties](../beginner/24-logical-properties.md) →
